...
export default function HomePage() {
  return (
    <main className="min-h-screen w-full">
          ...
          <div className="flex flex-col items-start">
            <div className="bg-yellow-300 p-4 rounded-lg">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                strokeWidth={1.5} stroke="currentColor" className="h-10 w-10 text-black">
      ...
      {/* Outcomes Grid */}
      <section className="w-full bg-gray-50 text-black py-24">
      ...
      {/* Impact Stats */}
      <section className="w-full bg-yellow-300 text-black py-24">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-3 gap-16 text-center">
          ...
          <div>
            ...
            <p className="mt-2 text-lg leading-relaxed">Readers worldwide</p>
          </div>

          <div>
            <h3 className="text-4xl font-bold">3,000+</h3>
            <p className="mt-2 text-lg leading-relaxed">Summaries available</p>
          </div>

          <div>
            <h3 className="text-4xl font-bold">94%</h3>
            <p className="mt-2 text-lg leading-relaxed">User satisfaction</p>
          </div>
            ...
            <div className="p-8 bg-gray-50 rounded-xl shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">Entrepreneur</p>
                </div>
              </div>
            ...
            <div className="p-8 bg-gray-50 rounded-xl shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">Marketing Manager</p>
                </div>
              </div>
              <p className="mt-6 text-gray-700 leading-relaxed">
            ...
            <div className="p-8 bg-gray-50 rounded-xl shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">Student</p>
                </div>
              </div>
              <p className="mt-6 text-gray-700 leading-relaxed">
